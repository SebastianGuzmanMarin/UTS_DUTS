 ...
 * @author Sebas
 */
public class PantallaCancelarEvento extends javax.swing.JFrame {

    /**
     * Creates new form PantallaEventosDisponibles
     */
    public PantallaCancelarEvento() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        EtiquetaMenu.setText("Cancelar Asistencia Evento");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PantallaCancelarEvento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PantallaCancelarEvento().setVisible(true);
            }
        });
    }
