...
public class PantallaEventosDisponibles extends javax.swing.JFrame {
     ...
     */
    public PantallaEventosDisponibles() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PantallaEventosDisponibles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PantallaEventosDisponibles().setVisible(true);
            }
        });
    }
